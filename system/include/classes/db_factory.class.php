...
final class db_factory
{
    ...
    public function connect($db_name)
    {
        ...
        switch ($this->db_config[$db_name]['type']) {
            case 'mysql':
                ys_base::load_sys_class('mysql', '', 0);
                $object = new mysql();
                break;
            case 'mysqli':
                $object = ys_base::load_sys_class('mysqli');
                break;
            case 'access':
                $object = ys_base::load_sys_class('db_access');
                break;
            default:
                ys_base::load_sys_class('mysql', '', 0);
                $object = new mysql();
